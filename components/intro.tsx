...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
       <span className="font-bold"> Hello I'm Oğuzhan.</span>
      I'm a {" "}
      <span className="font-bold">Computer Engineering Student</span>
      {" "} at {" "} Kocaeli University. I'm interested in {" "}
      ...
      {" "} and {" "}
      <span className="font-bold underline">.NET</span>
      {" "} and {" "}
      <span className="font-bold underline">PostgreSQL with AWS</span>
      {" "}. I want to learn {" "}
      <span className="font-bold underline">SAP</span>
      {" "} technologies. {" "}
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/o%C4%9Fuzhan-b%C3%BClb%C3%BCl-ba9b1b21b"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/oguzbulbul"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
